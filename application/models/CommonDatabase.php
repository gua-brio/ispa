...
class CommonDatabase extends CI_Model {
	...
	function get_data($table,$limit = 1,$start_id = false,$parent_field = false,$parent_value ="",$parent_field_2 = false,$parent_field_2_value = "",$order_by = false,$parent_field_3 = false,$parent_field_3_value = ""){		       
	...
	public function count($table,$field = false,$key = false,$field2 = false,$key2 = false,$field3 = false,$key3 = false){
		if ($field != false) {
			if ($field2 != false) {
				$condition = "$field='$key' AND $field2='$key2'";
			}elseif($field3 != false){
